...
Thank you for being interested in contributing to HTTPXP.
There are many ways you can contribute to the project:

- Try HTTPXP and [report bugs/issues you find](https://github.com/jerlendds/httpxp/issues/new)
- [Implement new features](https://github.com/jerlendds/httpxp/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- [Review Pull Requests of others](https://github.com/jerlendds/httpxp/pulls)
- Write documentation
- Participate in discussions

## Reporting Bugs or Other Issues

Found something that HTTPXP should support?
Stumbled upon some unexpected behaviour?

Contributions should generally start out with [a discussion](https://github.com/jerlendds/httpxp/discussions).
...
To start developing HTTPXP create a **fork** of the
[HTTPXP repository](https://github.com/jerlendds/httpxp) on GitHub.

Then clone your fork with the following command replacing `YOUR-USERNAME` with
your GitHub username:

```shell
$ git clone https://github.com/YOUR-USERNAME/httpxp
```
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/jerlendds/httpxp/master/docs/img/gh-actions-fail.png" alt='Failing PR commit status'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/jerlendds/httpxp/master/docs/img/gh-actions-fail-check.png" alt='Failing GitHub action lint job'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/jerlendds/httpxp/master/docs/img/gh-actions-fail-test.png" alt='Failing GitHub action test job'>
</p>
...
*This section is targeted at HTTPXP maintainers.*

Before releasing a new version, create a pull request that includes:

- **An update to the changelog**:
    - We follow the format from [keepachangelog](https://keepachangelog.com/en/1.0.0/).
    - [Compare](https://github.com/jerlendds/httpxp/compare/) `master` with the tag of the latest release, and list all entries that are of interest to our users:
...
[new release](https://github.com/jerlendds/httpxp/releases/new) including:
...
configure HTTPXP as described in the
[proxy section](https://github.com/jerlendds/httpxp/blob/master/docs/advanced.md#http-proxying) and
the [SSL certificates section](https://github.com/jerlendds/httpxp/blob/master/docs/advanced.md#ssl-certificates),
this is where our previously generated `client.pem` comes in:

```
import httpxp

ssl_context = httpxp.SSLContext()
ssl_context.load_verify_locations("/path/to/client.pem")

with httpxp.Client(proxy="http://127.0.0.1:8080/", ssl_context=ssl_context) as client:
