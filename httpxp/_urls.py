...
class URL:
    """
    url = httpxp.URL("HTTPS://jo%40email.com:a%20secret@müller.de:1234/pa%20th?search=ab#anchorlink")
    ...
    * `url.host` is normalized to always be lowercased. Internationalized domain
      ...
      url = httpxp.URL("http://中国.icom.museum")
      assert url.host == "中国.icom.museum"
      url = httpxp.URL("http://xn--fiqs8s.icom.museum")
      assert url.host == "中国.icom.museum"
    ...
    * `url.port` is either None or an integer. URLs that include the default port for
      ...
      assert httpxp.URL("http://example.com") == httpxp.URL("http://example.com:80")
      assert httpxp.URL("http://example.com").port is None
      assert httpxp.URL("http://example.com:80").port is None
    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can
    ...
    def __init__(self, url: URL | str = "", **kwargs: typing.Any) -> None:
        ...
        if isinstance(url, str):
            ...
            raise TypeError(
                "Invalid type for url.  Expected str or httpxp.URL,"
    ...
    def host(self) -> str:
        ...
        url = httpxp.URL("http://www.EXAMPLE.org")
        ...
        url = httpxp.URL("https://[::ffff:192.168.0.1]")
    ...
    def port(self) -> int | None:
        ...
        assert httpxp.URL("http://www.example.com") == httpxp.URL("http://www.example.com:80")
        assert httpxp.URL("http://www.example.com:80").port is None
        """
    ...
    def path(self) -> str:
        ...
        url = httpxp.URL("https://example.com/pa%20th")
        assert url.path == "/pa th"
        """
    ...
    def query(self) -> bytes:
        ...
        url = httpxp.URL("https://example.com/?filter=some%20search%20terms")
    ...
    def copy_with(self, **kwargs: typing.Any) -> URL:
        ...
        url = httpxp.URL("https://www.example.com").copy_with(
    ...
    def join(self, url: URL | str) -> URL:
        ...
        url = httpxp.URL("https://www.example.com/test")
...
class QueryParams(typing.Mapping[str, str]):
    ...
    def keys(self) -> typing.KeysView[str]:
        ...
        q = httpxp.QueryParams("a=123&a=456&b=789")
    ...
    def set(self, key: str, value: typing.Any = None) -> QueryParams:
        ...
        q = httpxp.QueryParams("a=123")
        q = q.set("a", "456")
        assert q == httpxp.QueryParams("a=456")
        """
        q = QueryParams()
    ...
    def add(self, key: str, value: typing.Any = None) -> QueryParams:
        ...
        q = httpxp.QueryParams("a=123")
        q = q.add("a", "456")
        assert q == httpxp.QueryParams("a=123&a=456")
        """
        q = QueryParams()
        q._dict = dict(self._dict)
    ...
    def merge(self, params: QueryParamTypes | None = None) -> QueryParams:
        ...
        q = httpxp.QueryParams("a=123")
        q = q.merge({"b": "456"})
        assert q == httpxp.QueryParams("a=123&b=456")

        q = httpxp.QueryParams("a=123")
        q = q.merge({"a": "456", "b": "789"})
        assert q == httpxp.QueryParams("a=456&b=789")
        """
